...
该晶面族的法向倒格矢为
\[
 \vb G=\frac{2\pi}{a}(1,2,3),\qquad
 \abs{\vb G}=\frac{2\pi}{a}\sqrt{14},
\]
故晶面间距为
\[
 d=\frac{2\pi}{\abs{\vb G}}
 =\boxed{\frac{a}{\sqrt{14}}}.
\]
倒格矢 $\vb G$ 与正格矢 $\vb R=a(1,2,3)$ 平行：$\vb G$ 标记晶面法向，$\vb R$ 只给出方向。
\end{solution}
\end{question}
