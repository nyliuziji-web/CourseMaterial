...
\begin{solution}
该分布关于 $0$ 对称，故 $\operatorname{E}[X]=0$。再算
\[
\operatorname{E}[X^2]=2\int_0^1 x^2(1-x)\,\dd{x}
=2\left(\frac13-\frac14\right)=\frac16.
\]
所以
\[
\operatorname{Var}(X)=\operatorname{E}[X^2]-\operatorname{E}[X]^2=\frac16.
\]
\end{solution}
\end{question}
...
由归一化条件
\[
1=\int_0^1\int_0^2\left(x^2+\frac{xy}{t}\right)\dd{y}\dd{x}
=\frac23+\frac1t,
\]
\begin{enumerate}[label=(\arabic*),leftmargin=2.8em,itemsep=0.2em]
\item \ansmath{t=3}
\item
\ansmath{P(x+y>1)=1-\int_0^1\int_0^{1-x}\left(x^2+\frac{xy}{3}\right)\dd{y}\dd{x}
=1-\frac{7}{72}=\frac{65}{72}}
\item
\ansmath{P(y>1\mid x<1/2)=
\frac{\int_0^{1/2}\int_1^2\left(x^2+\frac{xy}{3}\right)\dd{y}\dd{x}}
{\int_0^{1/2}\int_0^2\left(x^2+\frac{xy}{3}\right)\dd{y}\dd{x}}
=\frac58}
\end{enumerate}
\end{solution}
\end{question}
...
\ansmath{P=\operatorname{E}[(0.01)^N]
=\sum_{n=0}^{\infty}(0.01)^n \ee^{-60}\frac{60^n}{n!}
=\ee^{-60(1-0.01)}=\ee^{-59.4}}
\end{enumerate}
\end{solution}
\end{question}
