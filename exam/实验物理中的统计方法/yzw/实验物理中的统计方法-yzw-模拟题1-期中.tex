...
于是
\[
\operatorname{E}[Y]=E\bigl(\operatorname{E}[Y\mid X]\bigr)=\frac{1+\operatorname{E}[X]}{2}.
\]
而
\[
...
由全期望公式，
\[
\operatorname{E}[Y]=E(\operatorname{E}[Y\mid N])=\nu_2\operatorname{E}[N]=\nu_1\nu_2.
\]
由全方差公式，
\[
\operatorname{Var}(Y)=E(\operatorname{Var}(Y\mid N))+\operatorname{Var}(\operatorname{E}[Y\mid N])
...
期望为
\[
\operatorname{E}[R]=\int_a^b r\frac{2r}{b^2-a^2}\,dr
