...
\]
\[
\operatorname{E}[X^2]=\frac{a(2a+b)}{6(a+b)},\qquad
\operatorname{E}[Y^2]=\frac{b(a+2b)}{6(a+b)}.
\]
代回化简得
\[
...
进一步有
\[
\operatorname{E}[Y]=\int_0^\theta y\frac{n y^{n-1}}{\theta^n}\,dy
=\frac{n}{n+1}\theta,
\]
\[
\operatorname{E}[Y^2]=\int_0^\theta y^2\frac{n y^{n-1}}{\theta^n}\,dy
=\frac{n}{n+2}\theta^2.
\]
所以
\[
