...
于是
\[
\operatorname{Var}(X)=E[X^2]-E[X]^2=2-1=1.
\]
\ansmath{\operatorname{Var}(X)=E[X^2]-E[X]^2=2-1=1}
\end{solution}
\end{question}
...
\]
\ansmath{F_T(t)=1-e^{-\lambda t},\qquad
f_T(t)=\lambda e^{-\lambda t}\ (t\ge 0)}
\end{solution}
\end{question}
...
\begin{question}
$X$ 和 $Y$ 都服从标准正态分布，$Z=X-Y$，求 $E[Z]$，$E[|Z|]$，$V[|Z|]$。
\begin{solution}
有 $Z\sim N(0,2)$，所以
\[
E[Z]=0,
...
\]
\ansmath{\operatorname{Var}(|Z|)=2-\left(\frac{2}{\sqrt\pi}\right)^2=2-\frac{4}{\pi}}
\end{solution}
\end{question}
...
\]
\ansmath{\operatorname{Var}(r)=\frac{R^2}{2}-\left(\frac{2R}{3}\right)^2=\frac{R^2}{18}}
\end{solution}
\end{question}
