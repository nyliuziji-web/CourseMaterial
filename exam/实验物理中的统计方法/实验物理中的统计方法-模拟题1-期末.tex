...
对卡方分布，
\[
E[X]=2n,\qquad \operatorname{Var}(X)=4n.
\]
令
\[
g(x)=\sqrt{x},
...
\]
所以
\ansmath{\hat\lambda_{\rm MLE}=\bar X}
又有
\[
E[\bar X]=\lambda,\qquad \operatorname{Var}(\bar X)=\frac{\lambda}{n}.
\]
单个样本的 Fisher 信息为
\[
...
\]
即
\ansmath{\hat a=\frac{\sum_{i=1}^n \dfrac{x_i y_i}{\sigma_i^2}}
{\sum_{i=1}^n \dfrac{x_i^2}{\sigma_i^2}}}
...
\]
即
\ansmath{\operatorname{Var}(\hat a)=\frac{1}{\sum_{i=1}^n \dfrac{x_i^2}{\sigma_i^2}}}
代回可得
\[
\chi^2_{\min}
