...
\]
故
\ansmath{f_V(v)=\frac{1}{4\pi(b-a)\left(\frac{3v}{4\pi}\right)^{2/3}},
\qquad \frac{4\pi a^3}{3}<v<\frac{4\pi b^3}{3}}
又
\[
E[S]=4\pi E[R^2]
...
\]
所以
\ansmath{P\bigl(N(T/3)=2\mid N(T)=4\bigr)=\frac{8}{27}}
...
\]
故
\ansmath{f_{T_1\mid N(T)=4}(t)=\frac{4}{T}\left(1-\frac{t}{T}\right)^3,
\qquad 0<t<T}
\end{solution}
\end{question}
...
\]
故
\ansmath{P(e\mid 3)\approx 0.907}
同理
\[
...
\]
因此
\ansmath{P(e\mid 2)\approx 0.0196}
\end{solution}
\end{question}
