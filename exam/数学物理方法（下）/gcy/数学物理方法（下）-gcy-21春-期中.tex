...
正交性为
\[
\int_a^b \frac{1}{r}R_m(r)R_n(r)\dd{r}=0\qquad (m\ne n),
\]
模方为
\[
\int_a^b \frac{1}{r}R_n(r)^2\dd{r}=\frac12\ln\frac{b}{a}.
\]
\end{enumerate}

\ansmath{\int_a^b \frac{1}{r}R_m(r)R_n(r)\dd{r}=0\qquad (m\ne n),\quad \int_a^b \frac{1}{r}R_n(r)^2\dd{r}=\frac12\ln\frac{b}{a}}
...
\qquad
 a_n=\frac{2}{\pi}\int_0^{\pi}\sin x\cos nx\dd{x}.
\]
计算得
\[
 a_0=\frac{4}{\pi},
