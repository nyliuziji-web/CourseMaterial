...
\begin{align*}
&= \bigl[\alpha\bar y(0)\cdot\beta z'(0)-\beta\bar y'(0)\cdot\alpha z(0)\bigr]
- \bigl[\bar y(0)z'(0)-\bar y'(0)z(0)\bigr] \\
&= (\alpha\beta-1)\bigl[\bar y(0)z'(0)-\bar y'(0)z(0)\bigr].
\end{align*}
要使得对所有满足边界条件的 $y,z$ 均有 $[\bar y z'-\bar y' z]_{0}^{l}=0$，需且只需
\[
\boxed{\;\alpha\beta = 1\;}.
\]
此时该 Sturm--Liouville 本征值问题是自伴的，本征函数构成完备正交系。

\ansmath{\alpha\beta = 1}
