...
模方为
\[
\|X_n\|^2=\int_0^l X_n(x)^2\dd{x}=\frac l2.
\]
归一化后可取 $\sqrt{2/l}\,X_n(x)$。
\end{enumerate}
\ansmath{\lambda_n=E\mu_n^2=E\Bigl(\frac{(n+\tfrac12)\pi}{l}\Bigr)^2,
\qquad X_n(x)=\sin\frac{(n+\tfrac12)\pi x}{l}\quad \|X_n\|^2=\int_0^l X_n(x)^2\dd{x}=\frac l2}
...
对 $f(x)=x(\pi-x)$，
\[
A_0=\frac1\pi\int_0^{\pi}x(\pi-x)\dd{x}=\frac{\pi^2}{6}.
\]
对 $n\ge1$，
\[
A_n=\frac{2}{\pi}\int_0^{\pi}x(\pi-x)\cos nx\dd{x}
=\begin{cases}
...
故
\[
 w(x,t)=\sum_{n=0}^{\infty}c_n \ee^{-\kappa\mu_n^2 t}\cos\mu_n x.
\]
系数为
\[
 c_n=\frac{2}{l}\int_0^l\left(-\frac{q}{K}(l-x)\right)\cos\mu_n x\dd{x}
 =-\frac{2q}{Kl\mu_n^2}.
\]
因此
\ansmath{u(x,t)=\frac{q}{K}(l-x)-\sum_{n=0}^{\infty}\frac{2q}{Kl\mu_n^2}\ee^{-\kappa\mu_n^2 t}\cos\mu_n x,
