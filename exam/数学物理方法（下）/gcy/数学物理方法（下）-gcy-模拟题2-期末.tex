...
而准周期边界给出
\[
u(2\pi)=\ee^{i\theta}u(0),\qquad v(2\pi)=\ee^{i\theta}v(0),
\]
故
\[
[u\bar v]_0^{2\pi}=\ee^{i\theta}u(0)\ee^{-i\theta}\overline{v(0)}-u(0)\overline{v(0)}=0.
\]
...
相应本征函数可取
\ansmath{u_n(x)=\frac{1}{\sqrt{2\pi}}\ee^{i(n+\theta/(2\pi))x}.}
\end{enumerate}
\end{solution}
\end{question}
