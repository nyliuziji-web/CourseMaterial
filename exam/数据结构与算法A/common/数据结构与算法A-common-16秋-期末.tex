\heading{数据结构与算法A-common-16秋-期末}
...
\begin{enumerate}
  ...
  \item 若要使该图只有唯一的拓扑序列，则可以添加一条弧 \blank。
\end{enumerate}
\begin{solution}
...
\begin{tikzpicture}[>=stealth,scale=0.74,transform shape,
  ...
  \node[inner] (r) at (0,0) {};
  \node[inner] (d) at (-7.0,-1.45) {};
  \node[leaf] (dow) at (-7.6,-2.95) {};
  \node[leaf] (digo) at (-6.4,-2.95) {};
  \node[leaf] (g1) at (-5.3,-1.55) {};
  \node[inner] (i) at (-4.0,-1.45) {};
  \node[leaf] (igo) at (-4.6,-2.95) {};
  \node[inner] (nd) at (-3.4,-2.95) {};
  \node[leaf] (indow) at (-3.9,-4.45) {};
  \node[leaf] (indigo) at (-2.9,-4.45) {};
  \node[inner] (n) at (-1.8,-1.45) {};
  \node[leaf] (ndow) at (-2.4,-2.95) {};
  \node[leaf] (ndigo) at (-1.2,-2.95) {};
  \node[inner] (o) at (0.0,-1.45) {};
  \node[leaf] (ow) at (-0.6,-2.95) {};
  \node[leaf] (oend) at (0.6,-2.95) {};
  \node[inner] (w) at (2.0,-1.45) {};
  \node[leaf] (w1) at (1.4,-2.95) {};
  \node[leaf] (window) at (2.6,-2.95) {};
  \node[leaf] (dol) at (3.8,-1.55) {};
  \draw (r)--node[lab,sloped,pos=.78]{D}(d);
  \draw (d)--node[lab,sloped,pos=.58]{OW\$}(dow);
  \draw (d)--node[lab,sloped,pos=.58]{IGOS\$}(digo);
  \draw (r)--node[lab,sloped,pos=.74]{GOS\$}(g1);
  \draw (r)--node[lab,sloped,pos=.68]{I}(i);
  \draw (i)--node[lab,sloped,pos=.56]{GOS\$}(igo);
  \draw (i)--node[lab,sloped,pos=.60]{ND}(nd);
  \draw (nd)--node[lab,sloped,pos=.58]{OW\$}(indow);
  \draw (nd)--node[lab,sloped,pos=.58]{IGOS\$}(indigo);
  \draw (r)--node[lab,pos=.78]{N}(n);
  \draw (n)--node[lab,sloped,pos=.58]{DOW\$}(ndow);
  \draw (n)--node[lab,sloped,pos=.58]{DIGOS\$}(ndigo);
  \draw (r)--node[lab,sloped,pos=.68]{O}(o);
  \draw (o)--node[lab,sloped,pos=.58]{W\$}(ow);
  \draw (o)--node[lab,sloped,pos=.58]{\$}(oend);
  \draw (r)--node[lab,sloped,pos=.70]{W}(w);
  \draw (w)--node[lab,sloped,pos=.58]{\$}(w1);
  \draw (w)--node[lab,sloped,pos=.58]{INDOW\$}(window);
  \draw (r)--node[lab,sloped,pos=.78]{\$}(dol);
  \node[draw=none,fill=white,font=\scriptsize] at (-7.6,-3.35) {$(1,3)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-6.4,-3.35) {$(2,2)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-5.3,-1.95) {$(2,4)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-4.6,-3.35) {$(2,3)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-3.9,-4.85) {$(1,1)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-2.9,-4.85) {$(2,0)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-2.4,-3.35) {$(1,2)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-1.2,-3.35) {$(2,1)$};
  \node[draw=none,fill=white,font=\scriptsize] at (-0.6,-3.35) {$(1,4)$};
  \node[draw=none,fill=white,font=\scriptsize] at (0.6,-3.35) {$(2,5)$};
  \node[draw=none,fill=white,font=\scriptsize] at (1.4,-3.35) {$(1,5)$};
  \node[draw=none,fill=white,font=\scriptsize] at (2.6,-3.35) {$(1,0)$};
  \node[draw=none,fill=white,font=\scriptsize] at (3.8,-1.95) {$(1,6),(2,6)$};
\end{tikzpicture}
\end{center}
\end{solution}
\end{question}
