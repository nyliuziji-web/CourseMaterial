\heading{数据结构与算法B-common-21春-期末}
...
\begin{tikzpicture}[
  ...
  every node/.style={draw,circle,font=\small,minimum size=6mm,inner sep=0pt}
]
\node {45}
  child {node {18}}
  child {node {27}
...
\end{center}
  ...
  调整过程如下：
  \begin{center}
  \begin{tikzpicture}[x=7mm,y=7mm,every node/.style={draw,circle,font=\scriptsize,minimum size=4.8mm,inner sep=0pt}]
  \node (a1) at (0,0) {20}; \node (a2) at (-2,-1) {3}; \node (a3) at (2,-1) {7};
  \node (a4) at (-3,-2) {10}; \node (a5) at (-1,-2) {8}; \node (a6) at (1,-2) {53}; \node (a7) at (3,-2) {15};
  \node (a8) at (-3.5,-3) {31}; \node (a9) at (-2.5,-3) {20};
  \node (b1) at (7,0) {3}; \node (b2) at (5,-1) {20}; \node (b3) at (9,-1) {7};
  ...
  \node (c8) at (10.5,-3) {31}; \node (c9) at (11.5,-3) {20};
  \foreach \p in {a,b,c}{
    \foreach \u/\v in {1/2,1/3,2/4,2/5,3/6,3/7,4/8,4/9}
      \draw (\p\u)--(\p\v);
  }
  \draw[->] (3.2,-1.5) -- (3.9,-1.5);
  \draw[->] (10.2,-1.5) -- (10.9,-1.5);
  \end{tikzpicture}
  \end{center}
  ...
  \node (f1) at (14,0) {1}; \node (f2) at (12,-1) {2}; \node (f3) at (16,-1) {7};
  \node (f4) at (11,-2) {10}; \node (f5) at (13,-2) {3}; \node (f6) at (15,-2) {53}; \node (f7) at (17,-2) {15};
  \node (f8) at (10.5,-3) {31}; \node (f9) at (11.5,-3) {20}; \node (f10) at (12.5,-3) {20}; \node (f11) at (13.5,-3) {8};
  \foreach \p in {d,e,f}{
    \foreach \u/\v in {1/2,1/3,2/4,2/5,3/6,3/7,4/8,4/9,5/10,5/11}
      \draw (\p\u)--(\p\v);
  }
  \draw[->] (3.2,-1.5) -- (3.9,-1.5);
  \draw[->] (10.2,-1.5) -- (10.9,-1.5);
