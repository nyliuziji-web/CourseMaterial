...
\{\\
    int d, inc;\\
\underline{\hspace{12em}} /* (1) 散列地址 */ */\\
    for (inc = 0; inc < phash->m; inc++) \{\\
\underline{\hspace{12em}} /* (2) 检索成功 */ */\\
            *position = d;\\
            return TRUE;\\
        \}\\
        else if (phash->element[d].key == nil) \{\\
\underline{\hspace{12em}} /* (3) 检索失败，找到插入位置 */ */\\
            return FALSE;\\
        \}\\
\underline{\hspace{12em}} /* (4) 线性探查下一地址 */ */\\
    \}\\
\underline{\hspace{12em}} /* (5) 散列表溢出 */ */\\
\}\\
\end{tabular}
\end{quote}
