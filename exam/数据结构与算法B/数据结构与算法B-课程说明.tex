...
本目录下源文件命名规则：	exttt{数据结构与算法B-时间-期中/期末/样题-C/P}，其中 C/P 代表使用 C 语言或 Python 语言。扫描版 PDF 为原始试卷；对应的 \texttt{.tex} 文件为转录排版后的版本。C/P 两版除程序代码语言外，题目内容保持一致。
