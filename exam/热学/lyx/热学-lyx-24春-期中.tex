...
平衡分布
\[
f(z)=\frac{mg}{k_BT}\ee^{-mgz/(k_BT)},\qquad z>0.
\]
故平均重力势能
\[
...
\[
p_+\propto \ee^{-\varepsilon/(k_BT)},
\qquad p_-\propto \ee^{-\varepsilon/(k_BT)}.
\]
...
\left(1+\frac{mv_0^2}{2k_BT}\right)\ee^{-mv_0^2/(2k_BT)}.
\]
\end{question}
