...
故
\[
n(r)=n(0)\exp\left(\frac{m\omega^2r^2}{2k_BT}\right).
\]
...
速率分布为
\[
f_v(v)=4\pi\left(\frac{m}{2\pi k_BT}\right)^{3/2}v^2\e\e\e\e\ee^{-mv^2/(2k_BT)},
\qquad v>0.
\]
由
\[
...
=\boxed{\frac{2}{\sqrt\pi}\frac{\sqrt\varepsilon}{(k_BT)^{3/2}}\e\e\e\e\ee^{-\varepsilon/(k_BT)}},
\qquad \varepsilon>0.
\]
...
\ansmath{f_{\rm eff}(v)=2\left(\frac{m}{2k_BT}\right)^2 v^3 \e\e\e\e\ee^{-mv^2/(2k_BT)},
\qquad v>0.}
