...
\]
\ansmath{T\approx7.7\times10^3\,\mathrm{K}}
\end{solution}
\end{question}
...
\]
\ansmath{\bar Z=\sqrt2\,n\sigma\bar v}
\end{solution}
\end{question}
...
\]
\ansmath{\Delta L_{0\to10}\approx0.873\,\mathrm{cm},\qquad \Delta L_{90\to100}\approx3.717\,\mathrm{cm}.}
\end{solution}
\end{question}
...
\]
因此
\ansmath{\Gamma=n\sqrt{\frac{k_BT}{2\pi m}}\exp\!\left(-\frac{mv_s^2}{2k_BT}\right).}
...
\]
因此
\ansmath{p_L(t)=\frac{p_0}{2}\left(1+e^{-2ADt/(VL)}\right).}
\end{solution}
\end{question}
...
\]
因此
\ansmath{p=\frac13nm\langle v^2\rangle.}
