...
\ansmath{I=e_0 n\Delta L\sqrt{\frac{k_BT}{2\pi m}}}
\end{solution}
\end{question}
...
\]
\ansmath{\eta,\kappa,D,\lambda:\ \sqrt2,\sqrt2,2\sqrt2,2}
\end{solution}
\end{question}
...
\ansmath{\kappa_S=\frac1{(K+1)p},\qquad K_{DE}<-\frac13\text{；通常能量降低假设下 }-1<K_{DE}<-\frac13}
\end{solution}
\end{question}
...
\ansmath{\left\langle \frac12 a q^2\right\rangle=\frac12k_BT}
\end{solution}
\end{question}
