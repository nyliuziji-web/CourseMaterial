...
\begin{enumerate}[label=(\arabic*),leftmargin=2.5em]
  ...
  由热力学关系 $\dd{u}=T\,\dd{s}-p\,\dd{v}$ 得
  \[
  \dd{s}=\frac{c_V}{T}\,\dd{T}+\frac{k_B}{v-b}\,\dd{v},
  \]
  从而
  \[
...
由题设
\[
\dd{U}=aT^{d+1}\dd{V}+(d+1)aVT^d \dd{T},
\]
于是
\[
\dd{S}=\frac{\dd{U}+p\,\dd{V}}{T}=(a+b)T^d \dd{V}+(d+1)aVT^{d-1}\dd{T}.
\]
因此
\[
