...
\begin{enumerate}
  ...
  \item 归一化条件为
  \[
  1=\int_{-L}^{L}A^2(L-|x|)^2\,\dd{x}
  =2A^2\int_0^L(L-x)^2\,\dd{x}
  =\frac{2A^2L^3}{3}.
  \]
  取 $A>0$，得
  ...
  \[
  \int_0^L(L-x)\cos\frac{(2k-1)\pi x}{2L}\,\dd{x}
...
\begin{enumerate}
  \item 归一化条件为
  \[
  1=|A|^2\int_0^\infty r^4\ee^{-2r/a}\,\dd{r}\int\cos^2\theta\,\dd{\Omega}.
  \]
  其中
  \[
  \int\cos^2\theta\,\dd{\Omega}=\frac{4\pi}{3},
  \qquad
  \int_0^\infty r^4\ee^{-2r/a}\,\dd{r}=\frac{4!}{(2/a)^5}=\frac{3a^5}{4}.
  \]
