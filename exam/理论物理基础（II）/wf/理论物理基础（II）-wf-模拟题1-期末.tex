...
又因
\[
1+\cos\phi=1+\frac{\ee^{i\phi}+\ee^{-i\phi}}{2},
\]
所以
\[
...
随时间演化后
\[
\psi(\phi,t)=\sqrt{\frac23}\,\psi_0(\phi)+\ee^{-iE_1t/\hbar}\left[\frac{1}{\sqrt6}\,\psi_1(\phi)+\frac{1}{\sqrt6}\,\psi_{-1}(\phi)\right],
...
\[
|\psi(t)\rangle=\ee^{-iDt\hat S_y/\hbar}|1\rangle
