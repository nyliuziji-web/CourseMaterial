...
单粒子配分函数为
\[
Z_1=\frac{1}{h^3}\int d^3p\,\ee^{-\beta p^2/2m}\int d^3r\,\ee^{-\beta \alpha r^2/2}.
\]
动量积分给出
\[
\int d^3p\,\ee^{-\beta p^2/2m}=(2\pi m k_B T)^{3/2},
\]
位置积分为高斯积分，
\[
\int d^3r\,\ee^{-\beta \alpha r^2/2}
...
N_{\mathrm{ex}}^{\max}(T)
=
CV\int_0^\infty \frac{\varepsilon^{1/2}\,d\varepsilon}{\ee^{\beta\varepsilon}-1}.
\]
...
N_{\mathrm{ex}}^{\max}(T)
=
CV(k_B T)^{3/2}\int_0^\infty \frac{x^{1/2}\,dx}{\ee^x-1}.
\]
利用题给积分，
