...
\[
\psi_n(\phi)=\frac{1}{\sqrt{2\pi}}\ee^{in\phi},\qquad n\in\mathbb Z.
\]
作用哈密顿量即得
\ansmath{\psi_n(\phi)=\frac{1}{\sqrt{2\pi}}\ee^{in\phi},\qquad E_n=\frac{\hbar^2}{2mR^2}(n-\varphi)^2,\qquad n\in\mathbb Z.}
...
利用指数公式 $\ee^{-it\hat H/\hbar}=\cos(Et/\hbar)-i(\hat H/E)\sin(Et/\hbar)$，从初态 $|+\rangle_z$ 出发可得
\[
|\psi(t)\rangle=
