...
所以哈密顿量可写为
\[
\hat H=\frac{\hbar^2}{2mR^2}\left(-\ii\frac{d}{d\phi}-\varphi\right)^2.
\]
周期性边界条件要求本征函数仍为圆环上的平面波
\[
\psi_n(\phi)=\frac{1}{\sqrt{2\pi}}\ee^{\ii n\phi},\qquad n\in\mathbb Z.
\]
作用哈密顿量即得
\ansmath{\psi_n(\phi)=\frac{1}{\sqrt{2\pi}}\ee^{\ii n\phi},\qquad E_n=\frac{\hbar^2}{2mR^2}(n-\varphi)^2,\qquad n\in\mathbb Z.}
...
利用指数公式 $\ee^{-\ii t\hat H/\hbar}=\cos(Et/\hbar)-\ii(\hat H/E)\sin(Et/\hbar)$，从初态 $|+\rangle_z$ 出发可得
\[
|\psi(t)\rangle=
\left[\cos\frac{Et}{\hbar}-\ii\frac{B}{E}\sin\frac{Et}{\hbar}\right]|+\rangle_z
-\ii\frac{A}{E}\sin\frac{Et}{\hbar}\,|-\rangle_z.
\]
故
...
由上式直接读出
\[
P_z(+;t)=\left|\cos\frac{Et}{\hbar}-\ii\frac{B}{E}\sin\frac{Et}{\hbar}\right|^2
