...
因此
\[
n_r^\ast = A \ee^{-\beta\varepsilon_r},
\]
由归一化条件得到
\[
\frac{n_r^\ast}{N}=
\frac{\ee^{-\beta\varepsilon_r}}{1+\ee^{-\beta\varepsilon}+\ee^{-2\beta\varepsilon}}.
\]
即
\ansmath{
\frac{n_0^\ast}{N}=\frac{1}{1+\ee^{-\beta\varepsilon}+\ee^{-2\beta\varepsilon}},\quad
\frac{n_1^\ast}{N}=\frac{\ee^{-\beta\varepsilon}}{1+\ee^{-\beta\varepsilon}+\ee^{-2\beta\varepsilon}},\quad
\frac{n_2^\ast}{N}=\frac{\ee^{-2\beta\varepsilon}}{1+\ee^{-\beta\varepsilon}+\ee^{-2\beta\varepsilon}}.
}
...
故单振子配分函数是几何级数
\[
z=\sum_{n=0}^{\infty}\ee^{-n\beta\hbar\omega}
=\frac{1}{1-\ee^{-\beta\hbar\omega}}.
\]
由于各振子独立，
\ansmath{
Z_N=z^N=\left(1-\ee^{-\beta\hbar\omega}\right)^{-N}.
}

平均能量
\[
U=-\frac{\partial}{\partial\beta}\ln Z_N
=-N\frac{\partial}{\partial\beta}\ln\left(1-\ee^{-\beta\hbar\omega}\right)^{-1}
= N\frac{\hbar\omega}{\ee^{\beta\hbar\omega}-1}.
\]
因此
\ansmath{
U=N\frac{\hbar\omega}{\ee^{\hbar\omega/(kT)}-1}.
}
...
=Nk\,\frac{x^2\ee^x}{(\ee^x-1)^2}.
\]
故
\ansmath{
C_V=Nk\frac{\left(\hbar\omega/kT\right)^2\ee^{\hbar\omega/(kT)}}{\left(\ee^{\hbar\omega/(kT)}-1\right)^2}.
}
...
故
\ansmath{
C_V\approx Nk\,x^2\ee^{-x}
=Nk\left(\frac{\hbar\omega}{kT}\right)^2\ee^{-\hbar\omega/(kT)}.
}
\end{solution}
\end{question}
...
\]
其中 $z=\ee^{\beta\mu}$，$\lambda$ 为热德布罗意波长。
\begin{enumerate}[label=(\arabic*),leftmargin=2.8em,itemsep=0.2em]
\item 求 $\Xi$；
\item 求粒子数分布 $P(N)$；
...
则在 $T=0$ 时，
\[
N=\int_0^{\varepsilon_F}g(\varepsilon)\,\dd{\varepsilon}
...
基态总能量
\[
U=\int_0^{\varepsilon_F}\varepsilon\,g(\varepsilon)\,\dd{\varepsilon}
