...
\]
对偶宇称代入后，得到
\ansmath{\kappa=\frac{m\alpha}{\hbar^2}\left(1+\ee^{-2\kappa a}\right).}
对奇宇称代入后，得到
\ansmath{\kappa=\frac{m\alpha}{\hbar^2}\left(1-\ee^{-2\kappa a}\right).}
...
其右边在 $\kappa=0$ 附近展开为
\[
g\left(1-\ee^{-2\kappa a}\right)=2ag\,\kappa+O(\kappa^2).
\]
要使方程 $\kappa=g(1-\ee^{-2\kappa a})$ 在 $\kappa>0$ 处存在非零解，必须有右边在原点处斜率大于 $1$，即
\[
2ag>1.
\]
故奇宇称束缚态存在的条件为
...
\[
\kappa_+=g\left(1+\ee^{-2ga}\right)+O(\ee^{-4ga}),
\qquad
\kappa_-=g\left(1-\ee^{-2ga}\right)+O(\ee^{-4ga}).
\]
因此
\ansmath{\kappa_+\simeq \frac{m\alpha}{\hbar^2}\left(1+\ee^{-2m\alpha a/\hbar^2}\right),
\qquad
\kappa_-\simeq \frac{m\alpha}{\hbar^2}\left(1-\ee^{-2m\alpha a/\hbar^2}\right).}
对应能量分裂为偶宇称更低、奇宇称更高。
\end{solution}
\end{question}
...
\[
\psi_{200}(r,\theta,\phi)=\frac{1}{4\sqrt{2\pi a_0^3}}\left(2-\frac{r}{a_0}\right)\ee^{-r/(2a_0)},
\]
\[
\psi_{210}(r,\theta,\phi)=\frac{1}{4\sqrt{2\pi a_0^3}}\frac{r}{a_0}\cos\theta\,\ee^{-r/(2a_0)}.
\]
现在加入微扰哈密顿量
\[
\hat H'=F z,
...
=\int \psi_{200}^*(r,\theta,\phi)\,r\cos\theta\,\psi_{210}(r,\theta,\phi)\,\dd[3]{r}
=-3a_0.
\]
因此
...
于是时间演化为
\[
\psi(t)=\frac{1}{\sqrt2}\left(\ee^{-\ii E_+ t/\hbar}\psi_++\ee^{-\ii E_- t/\hbar}\psi_-\right).
\]
再化回原基底，得
\ansmath{\psi(t)=\ee^{-\ii E_2 t/\hbar}\left[\cos\left(\frac{3Fa_0 t}{\hbar}\right)\psi_{200}+\ii\sin\left(\frac{3Fa_0 t}{\hbar}\right)\psi_{210}\right].}
