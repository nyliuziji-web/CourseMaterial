...
于是时间演化为
\[
\psi(t)=\frac{1}{\sqrt2}\left(\ee^{-iE_+ t/\hbar}\psi_++\ee^{-iE_- t/\hbar}\psi_-\right).
\]
再化回原基底，得
\ansmath{\psi(t)=\ee^{-iE_2 t/\hbar}\left[\cos\left(\frac{3Fa_0 t}{\hbar}\right)\psi_{200}+i\sin\left(\frac{3Fa_0 t}{\hbar}\right)\psi_{210}\right].}
