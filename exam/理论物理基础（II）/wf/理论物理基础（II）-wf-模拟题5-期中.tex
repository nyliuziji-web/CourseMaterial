...
内部部分为
\[
Z_{\mathrm{int}}=1+3\ee^{-\beta\Delta},
\qquad \beta=\frac{1}{k_B T}.
\]
因此
\ansmath{Z_1=\frac{V}{\lambda^3}\left(1+3\ee^{-\beta\Delta}\right).}
对不可分辨经典粒子，
...
给出。由
\[
\ln Z_N=N\ln\frac{V}{\lambda^3}+N\ln(1+3\ee^{-\beta\Delta})-\ln N!
\]
可得平动部分贡献 $\tfrac32 Nk_B T$，内部部分贡献为
\[
N\Delta\frac{3\ee^{-\beta\Delta}}{1+3\ee^{-\beta\Delta}}.
\]
故
\ansmath{U=\frac32 Nk_B T+N\Delta\frac{3\ee^{-\beta\Delta}}{1+3\ee^{-\beta\Delta}}.}

进一步求导得
\ansmath{C_V=\frac32 Nk_B+3Nk_B(\beta\Delta)^2\frac{\ee^{-\beta\Delta}}{(1+3\ee^{-\beta\Delta})^2}.}
...
粒子数方程为
\[
N=\int_0^\infty \frac{g(\varepsilon)\,\dd{\varepsilon}}{\ee^{\beta(\varepsilon-\mu)}+1}
=\frac{mA}{\pi\hbar^2}k_B T\ln\left(1+\ee^{\beta\mu}\right).
\]
因此
\[
\ln(1+\ee^{\beta\mu})=\frac{\pi\hbar^2 n}{m k_B T}=\frac{\varepsilon_F}{k_B T},
\qquad
\varepsilon_F\equiv \frac{\pi\hbar^2 n}{m}.
\]
解得
\ansmath{\mu(T,n)=k_B T\ln\left(\ee^{\varepsilon_F/(k_B T)}-1\right).}

当 $T\ll T_F$ 时，$\mu=\varepsilon_F+O(\ee^{-\varepsilon_F/(k_B T)})$。内能可写为
\[
U=\int_0^\infty \frac{g(\varepsilon)\,\varepsilon\,\dd{\varepsilon}}{\ee^{\beta(\varepsilon-\mu)}+1}.
\]
对常数态密度应用 Sommerfeld 展开，得
\[
U=\frac{g(\varepsilon_F)\varepsilon_F^2}{2}+\frac{\pi^2}{6}g(\varepsilon_F)(k_B T)^2+O\!\left(\ee^{-\varepsilon_F/(k_B T)}\right).
\]
而零温内能为
\[
...
\]
于是
\ansmath{U=\frac{N\varepsilon_F}{2}+\frac{\pi^2}{6}\frac{mA}{\pi\hbar^2}(k_B T)^2+O\!\left(\ee^{-\varepsilon_F/(k_B T)}\right).}
从而
...
\[
N=\int_0^\infty \frac{g(\varepsilon)\,\dd{\varepsilon}}{\ee^{\beta(\varepsilon-\mu)}-1}
=\frac{mA}{2\pi\hbar^2}\int_0^\infty \frac{\dd{\varepsilon}}{z^{-1}\ee^{\beta\varepsilon}-1},
\qquad z=\ee^{\beta\mu}<1.
\]
令 $x=\beta\varepsilon$，可得
\[
N=\frac{mA}{2\pi\hbar^2}k_B T\int_0^\infty \frac{\dd{x}}{z^{-1}\ee^x-1}
