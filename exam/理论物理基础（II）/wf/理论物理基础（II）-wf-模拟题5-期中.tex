...
粒子数方程为
\[
N=\int_0^\infty \frac{g(\varepsilon)\,d\varepsilon}{\ee^{\beta(\varepsilon-\mu)}+1}
...
\[
U=\int_0^\infty \frac{g(\varepsilon)\,\varepsilon\,d\varepsilon}{\ee^{\beta(\varepsilon-\mu)}+1}.
\]
...
\[
N=\int_0^\infty \frac{g(\varepsilon)\,d\varepsilon}{\ee^{\beta(\varepsilon-\mu)}-1}
=\frac{mA}{2\pi\hbar^2}\int_0^\infty \frac{d\varepsilon}{z^{-1}\ee^{\beta\varepsilon}-1},
\qquad z=\ee^{\beta\mu}<1.
\]
令 $x=\beta\varepsilon$，可得
\[
N=\frac{mA}{2\pi\hbar^2}k_B T\int_0^\infty \frac{dx}{z^{-1}\ee^x-1}
