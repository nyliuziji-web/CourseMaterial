...
单粒子配分函数为
\[
Z_1=\frac{1}{h^3}\int d^3p\,\ee^{-\beta p^2/(2m)}\int_0^h dz\int_0^{2\pi}d\phi\int_0^R r\,dr\,\ee^{\beta m\Omega^2 r^2/2}.
\]
动量积分给出 $(2\pi m k_B T)^{3/2}$，再做空间积分得
\[
\int_0^R r \ee^{\beta m\Omega^2 r^2/2}dr
...
\]
即
\ansmath{U=\frac{N\hbar\omega}{2}\left[\frac12+\frac{1}{\ee^{\beta\hbar\omega}-1}+1+\frac{2}{\ee^{2\beta\hbar\omega}-1}\right].}
写得更紧凑一些就是
