...
单粒子配分函数为
\[
Z_1=\frac{1}{h^3}\int \dd[3]{p}\,\ee^{-\beta p^2/(2m)}\int_0^h \dd{z}\int_0^{2\pi}\dd{\phi}\int_0^R r\,\dd{r}\,\ee^{\beta m\Omega^2 r^2/2}.
\]
动量积分给出 $(2\pi m k_B T)^{3/2}$，再做空间积分得
\[
\int_0^R r \ee^{\beta m\Omega^2 r^2/2}\dd{r}
=\frac{1}{\beta m\Omega^2}\left(\ee^{\beta m\Omega^2 R^2/2}-1\right).
\]
故
\ansmath{Z_1=\frac{h\,2\pi}{\lambda^3}\cdot \frac{1}{\beta m\Omega^2}\left(\ee^{\beta m\Omega^2 R^2/2}-1\right).}
...
由归一化条件
\[
\int_0^h \dd{z}\int_0^{2\pi}\dd{\phi}\int_0^R r\,\dd{r}\,n(r)=N
\]
可得
\ansmath{n(r)=\frac{N\alpha}{\pi h\left(\ee^{\alpha R^2}-1\right)}\ee^{\alpha r^2},
\qquad
\alpha\equiv \frac{m\Omega^2}{2k_B T}.}

局域上仍满足理想气体状态方程 $p(r)=n(r)k_B T$，因此
\[
\frac{p(R)}{p(0)}=\frac{n(R)}{n(0)}=\ee^{\alpha R^2}.
\]
即
...
\[
N_\uparrow=\int_0^{\mu+\gamma B} g_1(\varepsilon)\,\dd{\varepsilon},
\qquad
N_\downarrow=\int_0^{\mu-\gamma B} g_1(\varepsilon)\,\dd{\varepsilon}.
\]
...
频率为 $\nu$ 的单振子配分函数为
\[
z(\nu)=\sum_{n=0}^{\infty}\ee^{-\beta(n+1/2)\hbar\nu}
=\frac{\ee^{-\beta\hbar\nu/2}}{1-\ee^{-\beta\hbar\nu}}.
\]
因此整个系统的配分函数为
...
=\frac{N}{2}\left[\hbar\omega\left(\frac12+\frac{1}{\ee^{\beta\hbar\omega}-1}\right)+2\hbar\omega\left(\frac12+\frac{1}{\ee^{2\beta\hbar\omega}-1}\right)\right].
\]
即

\ansmath{U=\frac{N}{2}\hbar\omega\left(\frac32+\frac{1}{\ee^{\beta\hbar\omega}-1}+\frac{2}{\ee^{2\beta\hbar\omega}-1}\right).}

令 $x=\beta\hbar\omega=\hbar\omega/(k_B T)$，则热容为
\ansmath{C_V=\frac{N}{2}k_B\left[\frac{x^2\ee^x}{(\ee^x-1)^2}+\frac{(2x)^2\ee^{2x}}{(\ee^{2x}-1)^2}\right].}
