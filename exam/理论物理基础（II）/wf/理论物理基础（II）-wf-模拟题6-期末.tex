...
由于 $\hat L^2$ 在本子空间中只是整体常数，只需考虑 $\ee^{-iDt\hat L_x/\hbar}$ 对初态的作用。它等价于绕 $x$ 轴旋转。由直接指数化或利用转动矩阵可得
\[
|\psi(t)\rangle=\ee^{-i\hbar t/I}\left[\cos(Dt)|1,0\rangle-
\frac{i\sin(Dt)}{\sqrt2}\bigl(|1,1\rangle+|1,-1\rangle\bigr)\right].
\]
故
\ansmath{|\psi(t)\rangle=\ee^{-i\hbar t/I}\left[\cos(Dt)|1,0\rangle-
\frac{i\sin(Dt)}{\sqrt2}\bigl(|1,1\rangle+|1,-1\rangle\bigr)\right].}
