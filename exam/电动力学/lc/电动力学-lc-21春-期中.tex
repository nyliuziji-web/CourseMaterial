...
\begin{enumerate}
  ...
  其中
  \[
    \sigma_l=\frac{2l+1}{2}\sigma_0\int_{-1}^{c_\alpha}P_l(x)\dd{x} .
  \]
  对 $l=0$，
  \[
...
\[
    \mathbf E(\mathbf r,t)=\mathbf E\,\ee^{\ii(kz-\omega t)},
\]
...
\begin{enumerate}
  ...
  \item 取圆偏振基
  \[
    \hat{\mathbf e}_+=\frac{\hat{\mathbf x}+\ii\hat{\mathbf y}}{\sqrt2},
    \qquad
    \hat{\mathbf e}_-=\frac{\hat{\mathbf x}-\ii\hat{\mathbf y}}{\sqrt2} .
  \]
  它们满足
  \[
    \hat{\mathbf e}_+\times\hat{\mathbf z}=\ii\hat{\mathbf e}_+,
    \qquad
    \hat{\mathbf e}_-\times\hat{\mathbf z}=-\ii\hat{\mathbf e}_- .
  \]
  设
  \[
    \mathbf x_\pm=x_\pm\hat{\mathbf e}_\pm\ee^{-\ii\omega t},
    \qquad
    \mathbf E_\pm=E_\pm\hat{\mathbf e}_\pm\ee^{-\ii\omega t} .
  \]
  代入运动方程。对 $+$ 分量，$\dot{\mathbf x}_+\times\mathbf B_0=\omega B_0x_+\hat{\mathbf e}_+\ee^{-\ii\omega t}$；对 $-$ 分量，$\dot{\mathbf x}_-\times\mathbf B_0=-\omega B_0x_-\hat{\mathbf e}_-\ee^{-\ii\omega t}$。因此
  \[
