...
\begin{enumerate}
  ...
  因此空气侧倏逝波的共同衰减因子为
  \[
    \frac{E(z)}{E(0)}=\ee^{-\kappa z} .
  \]
  在距离界面一个空气中波长 $z=\lambda_0$ 处，
  \[
    \boxed{\frac{E(\lambda_0)}{E(0)}=\ee^{-2\pi}} .
  \]
  题目给出的 $1\,\mathrm{V/m}$ 按界面处空气侧场强振幅理解，则
  \[
    \boxed{E(\lambda_0)=\ee^{-2\pi}\,\mathrm{V/m}
...
\begin{enumerate}
  ...
  \]
  \[
    B_x=\frac{\ii\omega k_y}{c^2k_\rho^2}E_0\sin k_xx\cos k_yy\cos k_zz,
  \]
  \[
    B_y=-\frac{\ii\omega k_x}{c^2k_\rho^2}E_0\cos k_xx\sin k_yy\cos k_zz .
  \]
  对 TE 模式，$E_z=0$，可取
  \[
  ...
  \[
    E_x=\frac{\ii\omega k_y}{k_\rho^2}B_0\cos k_xx\sin k_yy\sin k_zz,
  \]
  \[
    E_y=-\frac{\ii\omega k_x}{k_\rho^2}B_0\sin k_xx\cos k_yy\sin k_zz,
    \qquad E_z=0,
  \]
  \[
...
\begin{enumerate}
  ...
  \[
  \begin{aligned}
    E_1&=\int_{-\infty}^{\infty}P\,\dd{t} \\
    &=\frac{q^2C^2}{6\pi\varepsilon_0c^3}
      \int_{-\infty}^{\infty}\frac{\dd{t}}{(v^2t^2+b^2)^2} .
  \end{aligned}
  \]
  利用
  \[
  ...
  \[
    ...
    \int_0^\infty\frac{\dd{s}}{(s^2+b^2-2bs\sin\alpha)^2} .
  \]
  保留到 $\alpha$ 的一阶，
  \[
  ...
  又
  \[
    \int_0^\infty\frac{\dd{s}}{(s^2+b^2)^2}=\frac{\pi}{4b^3},
    \qquad
    \int_0^\infty\frac{s\,\dd{s}}{(s^2+b^2)^3}=\frac{1}{4b^4} .
  \]
  所以
  \[
    \frac{2}{v}\int_0^\infty\frac{\dd{s}}{(s^2+b^2-2bs\sin\alpha)^2}
