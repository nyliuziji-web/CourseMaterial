...
\begin{enumerate}
  ...
  但是作用量中的变化量为
  \[
    \int j^\mu\partial_\mu\chi\dd[4]{x}
    =\int \partial_\mu(j^\mu\chi)\dd[4]{x}
     -\int \chi\,\partial_\mu j^\mu\dd[4]{x} .
  \]
...
\begin{enumerate}
  \item 设真空中的单色平面波为
  \[
    \mathbf E=\mathbf E_0\ee^{\ii(\mathbf k\cdot\mathbf r-\omega t)},
    \qquad
    \mathbf B=\mathbf B_0\ee^{\ii(\mathbf k\cdot\mathbf r-\omega t)} .
  \]
  无源 Maxwell 方程给出
  \[
  ...
  \[
    \hat{\mathbf e}_+=\frac{\hat{\mathbf e}_1+\ii\hat{\mathbf e}_2}{\sqrt2},
    \qquad
    \hat{\mathbf e}_-=\frac{\hat{\mathbf e}_1-\ii\hat{\mathbf e}_2}{\sqrt2} .
  \]
  若
  ...
  \[
    ...
    \qquad
    \hat{\mathbf e}_2=\frac{\hat{\mathbf e}_+-\hat{\mathbf e}_-}{\sqrt2\,\ii}
  \]
  得
  \[
    E_+=\frac{E_1-\ii E_2}{\sqrt2},
    \qquad
    E_-=\frac{E_1+\ii E_2}{\sqrt2} .
  \]
\end{enumerate}
...
\begin{enumerate}
  ...
  \[
    ...
    \frac{\rho(\mathbf r',t_r)}{|\mathbf r-\mathbf r'|}\dd[3]{\mathbf r'},
    \qquad
    \mathbf A(\mathbf r,t)=\frac{\mu_0}{4\pi}\int
    \frac{\mathbf j(\mathbf r',t_r)}{|\mathbf r-\mathbf r'|}\dd[3]{\mathbf r'},
  \]
  其中
  \[
  ...
  \[
    A^\mu(x)=\mu_0\int G_{\rm ret}(x-x')j^\mu(x')\dd[4]{x'} .
  \]
  因而
  \[
  \begin{aligned}
    \partial_\mu A^\mu(x)
    &=\mu_0\int \partial_\mu G_{\rm ret}(x-x')j^\mu(x')\dd[4]{x'} \\
    &=-\mu_0\int \partial'_\mu G_{\rm ret}(x-x')j^\mu(x')\dd[4]{x'} \\
    &=\mu_0\int G_{\rm ret}(x-x')\partial'_\mu j^\mu(x')\dd[4]{x'} .
  \end{aligned}
  \]
...
\[
  ...
  =\frac{1}{r^2}\left\langle\frac{\dd{P}}{\dd{\Omega}}\right\rangle\hat{\mathbf r} .
\]
  积分 $\int(1+\cos^2\theta)\dd{\Omega}=16\pi/3$，得到
\[
...
\begin{enumerate}
  ...
  \[
    \frac{\dd{\boldsymbol\pi}}{\dd{t}}
    =\dot{\mathbf P}-q\frac{\dd{\mathbf A}}{\dd{t}}
    =q\left(-\nabla\varphi-\frac{\partial\mathbf A}{\partial t}
      +\dot{\mathbf r}\times(\nabla\times\mathbf A)\right).
  \]
  使用 $\mathbf E=-\nabla\varphi-\partial_t\mathbf A$ 与 $\mathbf B=\nabla\times\mathbf A$，得到相对论 Lorentz 力
  \[
    \boxed{\frac{\dd}{\dd{t}}(\gamma m\mathbf v)=q(\mathbf E+\mathbf v\times\mathbf B)} .
  \]
  非相对论极限 $\gamma\to1$ 下即
  \[
