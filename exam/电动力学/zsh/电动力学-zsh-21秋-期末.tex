...
\begin{enumerate}
  \item 相对论带电粒子的作用量为
  \[
    S=\int\left[-mc^2\sqrt{1-\frac{v^2}{c^2}}-q\varphi+q\mathbf v\cdot\mathbf A\right]\dd{t} .
  \]
  因而 Lagrangian 为
  \[
  ...
  其四维形式为
  \[
    S=-mc\int\dd{s}+q\int A_\mu\dd{x^\mu} .
  \]
  ...
  Euler--Lagrange 方程给出
  \[
    \frac{\dd{}}{\dd{t}}(\gamma m\mathbf v+q\mathbf A)
...
\begin{enumerate}
  ...
  又
  \[
    \frac{\dd{E}}{\dd{r}}=\frac{q^2}{8\pi\varepsilon_0r^2},
  \]
  所以
  \[
    \frac{\dd{r}}{\dd{t}}
