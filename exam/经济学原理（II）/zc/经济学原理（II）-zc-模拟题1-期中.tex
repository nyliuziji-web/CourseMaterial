...
此时面积为
\[
A'_L=0.008+0.028+0.053+0.088+0.155=0.332.
\]
故新的基尼系数
\[
...
对资产 $A$，
\[
\operatorname{E}(r_A)=0.5\times 30\%+0.5\times(-10\%)=10\%.
\]
偏差分别为 $20\%$ 与 $-20\%$，故方差
\[
...
同理，
\[
\operatorname{E}(r_B)=10\%,\qquad \sigma_B=20\%.
\]
...
因此
\[
\operatorname{E}(r_P)=10\%,\qquad \sigma_P=0.
\]
\ansmath{\operatorname{E}(r_A)=\operatorname{E}(r_B)=10\%,\quad \sigma_A=\sigma_B=20\%,}
\ansmath{\operatorname{E}(r_P)=10\%,\quad \sigma_P=0.}
