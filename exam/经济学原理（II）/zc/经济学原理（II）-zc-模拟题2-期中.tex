...
资产 $C$ 的期望收益率为
\[
\operatorname{E}(r_C)=0.5\times 40\%+0.5\times (-20\%)=10\%.
\]
资产 $D$ 的期望收益率为
\[
\operatorname{E}(r_D)=0.5\times (-10\%)+0.5\times 20\%=5\%.
\]
\ansmath{\operatorname{E}(r_C)=10\%,\quad \operatorname{E}(r_D)=5\%.}
