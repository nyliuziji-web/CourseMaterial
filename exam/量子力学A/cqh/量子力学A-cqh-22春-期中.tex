...
\[
  \kappa+\kappa'=g,\qquad
  \kappa'^2-\kappa^2={2mV\over\hbar^2}.
\]
代入 $\kappa'=g-\kappa$ 消去 $\kappa'$，得
\[
  (g-\kappa)^2-\kappa^2={2mV\over\hbar^2}
  \;\Longrightarrow\;
  \kappa={g\over2}-{mV\over g\hbar^2}.
\]
因此
\[
  E=-{\hbar^2\over2m}\kappa^2
  =-{\hbar^2\over2m}\left({g\over2}-{mV\over g\hbar^2}\right)^2,
\]
由 $\kappa>0$（束缚态）得存在条件为
\[
  g^2>{2mV\over\hbar^2}.
\]
归一化常数可取
