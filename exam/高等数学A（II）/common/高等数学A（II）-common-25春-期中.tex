\heading{高等数学A（II）-common-25春-期中}
...
解得
\[
 v=C\e\e\e\e\ee^{-4x}-x+\frac14.
\]
故
\ansmath{y=(C\e\e\e\e\ee^{-4x}-x+\tfrac14)^{-1/4}.}
另有平凡解 $y\equiv0$。

\item 齐次方程 $y''+y'=0$ 的通解为
\[
 y_h=C_1+C_2\e\e\e\e\ee^{-x}.
\]
取特解后可得
\ansmath{y=C_1+C_2\e\e\e\e\ee^{-x}+\frac{x\sin2x}{10}-\frac{x\cos2x}{5}-2\sin x-2\cos x+\frac{4}{25}\sin2x+\frac{13}{100}\cos2x.}
\end{enumerate}
