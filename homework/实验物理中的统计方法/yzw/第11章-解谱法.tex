...
\item
  ...
  两种情况分别构造偏置 \(b=\operatorname{E}[\hat\mu]-\mu\) 的估计量 \(\hat b\)。
\end{enumerate}
\begin{solution}
记
\[
...
若线性估计量写成 \(\hat\mu=An\)，且 \(\operatorname{E}[n]=R\mu\)，则
\[
b=\operatorname{E}[\hat\mu]-\mu=(AR-I)\mu.
\]
