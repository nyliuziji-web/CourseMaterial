...
\[
f_Z(z)=\int_z^1 1\cdot1\cdot\frac{1}{x}\,\dd{x}=-\log z,\qquad 0<z<1.
\]
...
\[
f_Z(z)=\int_z^1\frac1u\,\dd{u}=-\log z.
\]
...
\[
F(z)=P(XY\le z)=\int_0^z[-\log t]\,\dd{t}=z(1-\log z),\qquad 0<z<1.
\]
\end{solution}
\end{question}
...
\[
\begin{split}
\operatorname{E}[\alpha x+\beta]&=\alpha \operatorname{E}[x]+\beta,\\
...
\[
V[\alpha x+\beta]=\operatorname{E}[(\alpha x+\beta-\alpha \operatorname{E}[x]-\beta)^2]
=\operatorname{E}[\alpha^2(x-\operatorname{E}[x])^2]=\alpha^2V[x].
\]
\end{solution}
\end{question}
...
\begin{split}
V[\alpha x+y]
&=\operatorname{E}[(\alpha(x-\operatorname{E}[x])+(y-\operatorname{E}[y]))^2]\\
