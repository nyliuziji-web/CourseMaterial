...
\[
E\left[\frac1x\right]=\frac{1}{\beta-\alpha}\int_\alpha^\beta\frac1x\,\dd{x}
...
\[
F(x)=\int_0^x\frac1\xi \ee^{-t/\xi}dt=1-\ee^{-x/\xi},\qquad x\ge0.
\]
...
\begin{enumerate}
\item
  \(x=\ee^y\)，反变换 \(y=\log x\)，Jacobian 为 \(|dy/\dd{x}|=1/x\)。所以
\end{enumerate}
...
\[
F_{\chi^2}(x;n)=\frac{1}{\Gamma(n/2)}\int_0^{x/2}\ee^{-u}u^{n/2-1}du
