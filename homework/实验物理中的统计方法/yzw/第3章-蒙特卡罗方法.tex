...
理论上
\[
\operatorname{E}[X]=\int_0^1 x\,\dd{x}=\frac12,
\qquad
V[X]=\int_0^1 x^2\,\dd{x}-\left(\frac12\right)^2=\frac1{12}.
\]
一次典型模拟可能得到
\[
\bar x\simeq0.497,
...
分布函数为
\[
F(x)=\int_0^x\frac{2t}{x_{\max}^2}\,\dd{t}=\frac{x^2}{x_{\max}^2}.
\]
...
y=\sum_{i=1}^n x_i.
\]
因为 \(\operatorname{E}[x_i]=1/2\)、\(V[x_i]=1/12\)，独立性给出
\[
\operatorname{E}[y]=\sum_i \operatorname{E}[x_i]=\frac n2,
\qquad
...
\begin{solution}
设 \(t\sim\operatorname{Exp}(\tau)\)，即 \(\operatorname{E}[t]=\tau\)、\(V[t]=\tau^2\)，
...
\[
\operatorname{E}[y]=\operatorname{E}[t]+\operatorname{E}[x]=\tau,
\qquad
...
\[
\nu_{\rm out}=\operatorname{E}[n_{\rm out}]=\prod_{i=1}^{N}\nu_i.
\]
...
于是
\[
\operatorname{E}[Z_i]=\nu_i\operatorname{E}[Z_{i-1}],
\qquad
V[Z_i]=\nu_i\operatorname{E}[Z_{i-1}]+\nu_i^2V[Z_{i-1}].
\]
递推得到
\[
\operatorname{E}[n_{\rm out}]=\prod_{i=1}^N\nu_i,
\]
以及
\[
\frac{V[n_{\rm out}]}{\operatorname{E}[n_{\rm out}]^2}
...
\item 当 \(N=6\)、所有 \(\nu_i=3\) 时，
\[
\operatorname{E}[n_{\rm out}]=3^6=729,
\]
\[
...
\[
\operatorname{E}[n_{\rm out}]=6\cdot3^{11}=1062882,
\]
标准差由上面的递推公式给出，约为
\[
