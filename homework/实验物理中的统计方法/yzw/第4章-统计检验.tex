...
则
\[
P(H_0\mid\mathbf x)=\frac{1}{1+\ee^{-t}},
\qquad
P(H_1\mid\mathbf x)=\frac{1}{1+\ee^{t}}.
\]
\end{solution}
\end{question}
...
\(\nu_i=\operatorname{E}[n_i]\) 的预言，如图 4.2 所示。
