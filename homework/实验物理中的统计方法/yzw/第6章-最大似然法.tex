...
\[
\operatorname{E}[U]=\int L\frac{\partial\log L}{\partial\theta}d\mathbf x
...
=E\left[\frac{\partial U}{\partial\theta}\right]+\operatorname{E}[U^2]
=E\left[\frac{\partial^2\log L}{\partial\theta^2}\right]+\operatorname{E}[U^2].
\]
故
\[
\operatorname{E}[U^2]=-E\left[\frac{\partial^2\log L}{\partial\theta^2}\right].
\]
...
所以
\[
\operatorname{E}[\hat\lambda]=nE\left[\frac1S\right]
=\lambda\frac{n}{n-1},
\qquad
