...
\item
  ...
  \(a_1=x\)，\(a_2=x^2\)，使得期待值 \(\operatorname{E}[a_i(x)]\) 对应于 \(x\)
  的一阶和二阶代数矩。
\item
...
\[
\operatorname{E}[x]=\mu,
\qquad \operatorname{E}[x^2]=\mu^2+\sigma^2.
\]
...
\[
\operatorname{E}[\hat\mu]=\operatorname{E}[\overline x]=\mu,
\]
...
\[
\operatorname{E}[x]=\int_{-1}^1 x f(x;\eta)\,\dd{x} = 0.
\]
...
\[
\operatorname{E}[x^2]=\int_{-1}^1 x^2 f(x;\eta)\,\dd{x}
=\frac{1-\eta}{2}\int_{-1}^1 x^2\dd{x} + \frac{3\eta}{2}\int_{-1}^1 x^4\dd{x}.
\]

利用

\[
\int_{-1}^1 x^2\dd{x}=\frac23,
\qquad
\int_{-1}^1 x^4\dd{x}=\frac25,
\]

得到

\[
\operatorname{E}[x^2]=\frac{1-\eta}{3}+\frac{3\eta}{5}=\frac{5+4\eta}{15}.
\]
...
\item 计算 \(\operatorname{E}[\hat\eta]\) 与 \(V[\hat\eta]\)

由构造直接知道

\[
\operatorname{E}[\hat\eta]=\eta,
\]
...
\[
\operatorname{E}[x^4]=\frac{1-\eta}{2}\int_{-1}^1 x^4\dd{x} + \frac{3\eta}{2}\int_{-1}^1 x^6\dd{x}.
\]

再用

\[
\int_{-1}^1 x^6\dd{x}=\frac27,
\]

得到

\[
\operatorname{E}[x^4]=\frac{1-\eta}{5}+\frac{3\eta}{7}=\frac{7+8\eta}{35}.
\]

于是

\[
V(\overline{x^2})=\frac1n\left(\operatorname{E}[x^4]-\operatorname{E}[x^2]^2\right).
\]
