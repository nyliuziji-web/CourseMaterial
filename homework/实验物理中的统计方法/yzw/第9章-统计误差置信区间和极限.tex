\heading{实验物理中的统计方法-第9章 统计误差、置信区间和极限}
...
\[
g(\hat\xi;\xi)=\frac{n^n}{(n-1)!}\frac{\hat\xi^{n-1}}{\xi^n}\ee^{-n\hat\xi/\xi}.
\]
...
\[
F_{\chi^2}(2x;2n)=P(x,n)\equiv\frac1{\Gamma(n)}\int_0^x \ee^{-t}t^{n-1}\,dt.
\]
