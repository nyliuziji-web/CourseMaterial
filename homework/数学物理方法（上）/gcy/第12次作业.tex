...
计算下列积分值：
\begin{enumerate}
  \item \(\displaystyle\int_0^\infty \frac{x\sin x}{1+x^4}\dd{x}\)

  \item \(\displaystyle\int_{-\infty}^\infty \frac{\cos x}{x^2-2x+2}\dd{x}\)

  \item
  \[
  \int_0^\infty
  \frac{\cos((a+2n)x)-\cos(ax)}{x(1+x^2)\sin x}\dd{x},
  \qquad a>-1,\quad n\in\mathbb{N}_+.
  \]
\end{enumerate}

\begin{solution}
\begin{enumerate}
  \item 考察上半圆围道 \(C\)，令 \(f(z)=\dfrac{z\ee^{\ii z}}{1+z^4}\)，有
\[

\begin{aligned}
\oint_C f(z)\dd{z}
&=\int_{-R}^{R}f(x)\dd{x}+\int_{C_R}f(z)\dd{z}\\
&=2\pi\ii\Bigl(\operatorname{res}\Bigl\{f(z),\frac{1+\ii}{\sqrt2}\Bigr\}
   +\operatorname{res}\Bigl\{f(z),\frac{-1+\ii}{\sqrt2}\Bigr\}\Bigr)
\end{aligned}
\]
...
\]
  ...
  \item 考察上半圆围道 \(C\)，令 \(f(z)=\dfrac{\ee^{\ii z}}{z^2-2z+2}=\dfrac{\ee^{\ii z}}{(z-1+\ii)(z-1-\ii)}\)，有
\[
...
故
\[
\int_{-\infty}^{\infty}\frac{\cos x}{x^2-2x+2}\dd{x}
=\Re\int_{-\infty}^{\infty}f(x)\dd{x}
=\frac{\pi}{\ee}\cos1.
\]
...
又根据补充引理，有
\[
g(z)=\frac{\ii\sum_{k=1}^{n}\ee^{-\ii(2k-1+a)z}}{z(1+z^2)},
\]
\[
\lim_{R\to+\infty}\int_{C_R}g(z)\dd{z}
=2\pi\ii\left[
\operatorname{res}(g,\ii)+\operatorname{res}(g,-\ii)+\operatorname{res}(g,0)
\right].
\]
...
\[
\begin{aligned}
\operatorname{res}(g,\ii)
&=\frac{\ee^{n+a}}{2\ii}\frac{\sinh n}{\sinh1},\\
\operatorname{res}(g,-\ii)
&=\frac{\ee^{-n-a}}{2\ii}\frac{\sinh n}{\sinh1},\\
\operatorname{res}(g,0)&=n\ii,
\end{aligned}
\]
...
\frac{\ii\sum_{k=1}^{n}\ee^{-\ii(2k-1+a)z}}{z(1+z^2)}\dd{z}
&=\pi\frac{\sinh(2n+a)-\sinh a}{\sinh1}\\
&\quad-2\pi n.
\end{aligned}
\]
...
\begin{tikzpicture}[scale=0.8]
  ...
  \foreach \ang/\label in {20/1, 70/2, 150/3, 230/4, 320/5} {
    \filldraw (\ang:3.5) circle (2pt);
    \node at (\ang:4.0) {$\beta_{\label}$};
  }
...
计算下列积分：
\begin{enumerate}
  \item \(\displaystyle\operatorname{v.p.}\int_{0}^{\infty}\frac{dx}{1-x^3}\)

  \item
  \[
  \operatorname{v.p.}\int_{-\infty}^{\infty}
  \frac{\cos(x+a)\sin(x-a)}{x^2-a^2}\dd{x},
  \qquad a>0.
  \]

  \item \(\displaystyle\int_0^{\infty}\frac{1-\cos x}{x^2(1+x^2)}\dd{x}\)

  \item \(\displaystyle\int_{-\infty}^{\infty}\frac{\ee^{px}-\ee^{qx}}{1-\ee^{x}}\dd{x},\quad 0<p<1,\ 0<q<1\)

  \item \(\displaystyle\operatorname{v.p.}\int_0^{\infty}\frac{x^{s}}{1-x^2}\dd{x},\quad -1<s<1\)
\end{enumerate}

\begin{solution}
\begin{enumerate}
  \item 设 \(f(z)=\dfrac{1}{1-z^3}\)，其有三个奇点 \(z=1,\ \ee^{\ii2\pi/3},\ \ee^{-\ii2\pi/3}\)，因此我们不妨考察如下围道：
...
\]
  ...
  \item 由
  \[
  \frac{\cos(x+a)\sin(x-a)}{x^2-a^2}
  =\frac{\sin(2x)-\sin(2a)}{2(x^2-a^2)}
  =\Im\left\{\frac{\ee^{2\ii x}-\ee^{2\ii a}}
  {2(x^2-a^2)}\right\},
  \]
  令
  \[
  f(z)=\frac{\ee^{2\ii z}-\ee^{2\ii a}}{2(z^2-a^2)},
  \]
  并考察如下围道：
...
根据小圆弧引理，由于
\[
\lim_{z\to-a}(z+a)f(z)=\frac{\ee^{-2\ii a}-\ee^{2\ii a}}{2(-2a)}=\frac{\ii\sin(2a)}{2a},\qquad \lim_{z\to a}(z-a)f(z)=0
\]
因此可以得到
\[
\lim_{\delta_1\to0}\int_{C_{1,\delta_1}}f(z)\dd{z}=\frac{\pi\sin(2a)}{2a},\qquad \lim_{\delta_2\to0}\int_{C_{2,\delta_2}}f(z)\dd{z}=0
\]
...
综上可以得到
\[
\operatorname{v.p.}\int_{-\infty}^{\infty}f(x)\dd{x}=-\frac{\pi\sin(2a)}{2a}
\]
\[
\int_{-\infty}^{\infty}\frac{\cos(x+a)\sin(x-a)}{x^2-a^2}\dd{x}=\Im\Bigl\{\int_{-\infty}^{\infty}f(x)\dd{x}\Bigr\}=0
\]

  \item 设 \(f(z)=\dfrac{1-\cos z}{z^2(1+z^2)}\)，因此不妨考察上半圆围道
\[
...
\begin{tikzpicture}[scale=0.7]
  ...
  \node at (0,2) [above right=3pt] {$2\pi\ii$};
  \node at (3,0) [above=3pt] {$R$};
  \node at (-3,0) [below=3pt] {$-R$};
\end{tikzpicture}
\end{center}

不妨先计算 \(\displaystyle\operatorname{v.p.}\int_{-\infty}^{\infty}\frac{\ee^{px}}{1-\ee^{x}}\dd{x}\).

  \item 设 \(f(z)=\dfrac{z^{s}}{1-z^{2}}\)，考察玦形围道 \(C\)，有
