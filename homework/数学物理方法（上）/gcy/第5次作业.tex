...
计算下列积分
\begin{enumerate}
  \item \(\displaystyle \oint_{C} \frac{1}{z^2-1} \sin \frac{\pi z}{4} \dd{z}\)，\(C\) 分别为：

\begin{enumerate}
  \item \(|z|=\dfrac12\)，
  \item \(|z-1|=1\)，
  \item 心形曲线 \(r=2(1-\sin\theta)\)，
  \item \(|z|=R,\;R\to\infty\).

\end{enumerate}
  \item \(\displaystyle \oint_{C} \frac{1}{z^2+1} \ee^{\ii z} \dd{z}\)，\(C\) 分别为：

\begin{enumerate}
  \item \(|z-\ii|=1\)，
  \item \(|z|=2\)，
  \item \(|z+\ii|+|z-\ii|=2\sqrt{2}\)，
  \item 闭合曲线 \(r=3-\sin^2\frac{\theta}{4}\).
\end{enumerate}
\end{enumerate}
...
\end{enumerate}
  \item
\begin{enumerate}
  \item \(|z-\ii|=1\) 包含 \(\ii\)，因此积分
\[ I=2\pi\ii \left.\frac{1}{z+\ii}\ee^{\ii z}\right|_{z=\ii}= \frac{\pi}{\ee} \]

  \item \(|z|=2\) 包含 \(\pm\ii\)，因此积分
\[ I=2\pi\ii \left.\frac{1}{z-\ii}\ee^{\ii z}\right|_{z=-\ii}+2\pi\ii \left.\frac{1}{z+\ii}\ee^{\ii z}\right|_{z=\ii}=-\pi\ee+\frac{\pi}{\ee} \]

  \item \(|z+\ii|+|z-\ii|=2\sqrt{2}\) 为焦点在 \(\pm\ii\)，长半轴为 \(\sqrt{2}\) 的椭圆，因此其包含 \(\pm\ii\)，因此积分
\[ I=2\pi\ii \left.\frac{1}{z-\ii}\ee^{\ii z}\right|_{z=-\ii}+2\pi\ii \left.\frac{1}{z+\ii}\ee^{\ii z}\right|_{z=\ii}=-\pi\ee+\frac{\pi}{\ee} \]

  \item 闭合曲线为 \(r=3-\dfrac{1-\cos(\theta/2)}{2}=\dfrac52+\dfrac12\cos\dfrac{\theta}{2}\)，因此闭合曲线绕 \(\pm\ii\) 两点两周，因此积分
...
计算下列积分
\begin{enumerate}
  \item \(\displaystyle \oint_{|z|=2} \frac{\cos z}{z} \dd{z}\)，\qquad
  \item \(\displaystyle \oint_{|z|=2} \frac{z^2-1}{z^2+1} \dd{z}\)，\qquad
  \item \(\displaystyle \oint_{|z|=2} \frac{\sin \ee^{z}}{z} \dd{z}\)，\qquad
  \item \(\displaystyle \oint_{|z|=2} \frac{\ee^{z}}{\cosh z} \dd{z}\)，\qquad
  \item \(\displaystyle \oint_{|z|=2} \frac{\sin z}{z^2} \dd{z}\)，\qquad
  \item \(\displaystyle \oint_{|z|=2} \frac{\cosh z}{\ee^{z}} \dd{z}\).
\end{enumerate}

\begin{solution}
\begin{enumerate}
  \item 围道包含了原点，因此 \(I_1 = 2\pi\ii \left.\cos z\right|_{z=0}=2\pi\ii\).

  \item 围道包含了 \(\pm\ii\)，因此
\[ I_2 = 2\pi\ii \left.\frac{z^2-1}{z-\ii}\right|_{z=-\ii} + 2\pi\ii \left.\frac{z^2-1}{z+\ii}\right|_{z=\ii} = 0. \]

  \item 围道包含了原点，因此 \(I_3=2\pi\ii \left.\sin\ee^{z}\right|_{z=0}=2\pi\ii\sin 1\).

  \item 注意到 \(\ee^{z}/(\cosh z)\) 在 \(\mathbb{C}\setminus\{\pi\ii/2,-\pi\ii/2\}\) 上解析，因此我们由柯西定理，考察如下区域可知
\begin{center}
...
\filldraw (0,-1.57) circle (2pt) node[right] {$-\frac{\pi}{2}i$};
\node at (1.5,1.3) {$C$};
\node at (-0.35,1.57) [left=2pt] {$C_1$};
\node at (-0.35,-1.57) [left=2pt] {$C_2$};
\end{tikzpicture}
\end{center}
...
\[ I_4=2\pi\ii \left.\frac{\ee^{z}}{\ii}\right|_{z=\pi\ii/2} + 2\pi\ii \left.\frac{\ee^{z}}{(-\ii)}\right|_{z=-\pi\ii/2} = 4\pi\ii. \]
  ...
  \item 围道包含了原点，而在原点附近，\((\sin z)/z \approx 1\)，因此有 \(I_5=2\pi\ii\).

  \item \((\cosh z)/\ee^{z}\) 在 \(\mathbb{C}\) 上解析，因此 \(I_6=0\).
\end{enumerate}
\end{solution}
\end{question}
...
\[
\dd{\theta}=\frac{2\dd{u}}{1+u^2},\qquad \cos\theta=\frac{1-u^2}{1+u^2},
\]
所以有
\[
\begin{aligned}
I&=\int_{-\infty}^{\infty}\frac{2\rho\dd{u}}{(\rho^2+|a|^2)(1+u^2)-2\rho|a|(1-u^2)}\\
&=2\rho\int_{-\infty}^{\infty}\frac{\dd{u}}{(\rho-|a|)^2+(\rho+|a|)^2u^2}\\
