...
1.  \textbf{收敛性}：考察序列的极限 \(\displaystyle\lim_{n\to\infty} a_n = \lim_{n\to\infty} n z^n\)。
    \begin{itemize}
...
2.  \textbf{绝对收敛性}：\lq\lq 绝对收敛\rq\rq\ 对序列而言，指其绝对值构成的序列 \(\{|a_n|\}\) 收敛。
...
1.  当 \(|z| < 1\) 时，\(\displaystyle\lim_{N\to\infty} z^{N+1} = 0\)。
    \[
...
2.  当 \(|z| > 1\) 时，\(\displaystyle\lim_{N\to\infty} z^{N+1} = \infty\)，因此 \(\displaystyle\lim_{N\to\infty} \frac1{1-z^{N+1}} = 0\)。
    \[
...
\begin{enumerate}
  ...
  \item
    ...
    \begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{figures/7-4.png}
    \end{figure}
  \item
...
\begin{enumerate}
  ...
  \item\(c_n = \dfrac{\ln n}{n!}\)。
    ...
    \]
    \(R = \infty\)。
  \item\(c_n = \Bigl(1-\dfrac1n\Bigr)^{n^2}\)。
    \[
    \frac1R = \varlimsup_{n\to\infty} |c_n|^{1/n} = \varlimsup_{n\to\infty} \Bigl[\Bigl(1-\frac1n\Bigr)^{n^2}\Bigr]^{1/n} = \varlimsup_{n\to\infty} \Bigl(1-\frac1n\Bigr)^{n}
    \]
    \[
    \frac1R = \varlimsup_{n\to\infty} \Bigl(1-\frac1n\Bigr) = 1
    \]
    \(\displaystyle 1/R = 1 \Rightarrow R = 1\)。
\end{enumerate}
\end{solution}
\end{question}
