...
(2) \(\ln \frac{1+z}{1-z}\) 在 \(z=\infty\) 处展开，规定 \(\bigl. \ln \frac{1+z}{1-z} \bigr|_{z=\infty}=(2k+1) \pi \ii\)。
\begin{solution}
(1) 有 \(\arctan z = \frac{1}{2\ii} \ln \frac{1+\ii z}{1-\ii z}\)，在 \(z=0\) 处展开，则有
\[
...
(2) 代入 \(z=1/t\)，有 \(\ln \frac{1+z}{1-z} = \ln \frac{t+1}{t-1}\)，由题 \(\ln (-1+z)=(2k+1) \pi \ii + \ln(1-z)=(2k+1)\pi \ii - \sum_{k=1}^\infty \frac{z^k}{k}\)。因此可以得到
\[
...
令 \(n = k+l\)，则有
\[
-\ln(1-z) \ln(1+z) = \sum_{n=2}^\infty \left[\sum_{k=1}^{n-1} \frac{(-)^{n-k+1}}{k(n-k)}\right] z^n
\]
...
因此有
\[
-\ln(1-z) \ln(1+z) = \sum_{n=1}^\infty \left[\sum_{k=1}^{2n-1} \frac{(-)^{k+1}}{k(2n-k)}\right] z^{2n}
\]
...
\[
\ln(1+z^2) \arctan z
= \sum_{n=2}^\infty \left[\sum_{k=1}^{n-1} \frac{(-)^n}{k\,(2(n-k)-1)}\right] z^{2n-1}
\]
\end{solution}
\end{question}
