...
\[
A_{mn}=\frac{2u_0}{hN_m}\int_0^a f(\rho)J_0(\alpha_m\rho)\rho\,\dd{\rho}
\int_0^h\sin\frac{n\pi z}{h}\,\dd{z},
\]
其中
\[
...
\int_0^a f(\rho)J_0(\alpha_m\rho)\rho\,\dd{\rho} .
\]
\end{solution}
\end{question}
...
\left(1-\ee^{-\kappa(\alpha_n/a)^2t}\right)
j_1(\alpha_nr/a).
\]
其中
\[
...
\left(\frac1z\frac{\dd}{\dd{z}}\right)^n\frac{\cos z}{z}.
\]
