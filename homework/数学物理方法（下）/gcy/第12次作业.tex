...
\sin\frac{m\pi x}{a}\cos\frac{n\pi y}{b}\,\dd{y}\,\dd{x}.
\]
\end{solution}
\end{question}
...
\qquad
a_l=\frac{2l+1}{2}\int_{-1}^{1}f(\mu)P_l(\mu)\,\dd{\mu}.
\]
球内有界解为
\[
...
算子
\[
L=\frac{\dd}{\dd{x}}\left[(1-x^2)\frac{\dd}{\dd{x}}\right]
\]
...
\[
\frac{\dd}{\dd{x}}\left[(1-x^2)G_x\right]=\frac12.
\]
