...
\[
A_n=\frac1l\int_0^{2l}\varepsilon(l-x)\cos\frac{n\pi x}{2l}\,\dd{x}
...
Axy(l-x)(l-y)
\sin\frac{m\pi x}{l}\sin\frac{n\pi y}{l}\,\dd{x}\dd{y}.
\]
由于积分可分离，
\[
\int_0^l x(l-x)\sin\frac{m\pi x}{l}\,\dd{x}
...
其中
\[
c_n=\frac2l\int_0^l\cos\frac{(n+\frac12)\pi x}{l}\,\dd{x}
...
\left(\ee^{-\beta t}-\ee^{-\kappa\lambda_nt}\right).
\]
代回即得解。
\end{solution}
\end{question}
...
边界 \(y=\pm b/2\) 给出
\[
A_n=-\frac2a\int_0^a x(a-x)\sin\frac{n\pi x}{a}\,\dd{x}
...
\quad t>0,\\
u_x(0,t)=A \ee^{-\alpha^2\kappa t},
\quad u(l,t)=B \ee^{-\beta^2\kappa t},\\
u(x,0)=0.
\end{cases}
\]
\begin{solution}
设
\[
u=P(x)\ee^{-\alpha^2\kappa t}+Q(x)\ee^{-\beta^2\kappa t}+v(x,t),
\]
其中
\[
P''+\alpha^2P=0,
