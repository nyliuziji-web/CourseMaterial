...
\[
z_\alpha = \frac{q_\alpha+\ii p_\alpha}{\sqrt2},\qquad
z_\alpha^* = \frac{q_\alpha-\ii p_\alpha}{\sqrt2}.
\]
...
p_\alpha = \frac{z_\alpha-z_\alpha^*}{\ii\sqrt2}.
\]
...
+\frac{1}{\ii\sqrt2}\frac{\partial f}{\partial p_\alpha}
= \frac{1}{\sqrt2}\left(\frac{\partial f}{\partial q_\alpha}
-\ii\frac{\partial f}{\partial p_\alpha}\right),
\]
\[
\frac{\partial f}{\partial z_\alpha^*}
= \frac{\partial f}{\partial q_\alpha}\frac{\partial q_\alpha}{\partial z_\alpha^*}
...
+\ii\frac{\partial g}{\partial p_\alpha}\right) \\
&\qquad\qquad
-\frac{1}{\sqrt2}\left(\frac{\partial f}{\partial q_\alpha}
+\ii\frac{\partial f}{\partial p_\alpha}\right)
\frac{1}{\sqrt2}\left(\frac{\partial g}{\partial q_\alpha}
-\ii\frac{\partial g}{\partial p_\alpha}\right)
\Bigg] \\
&= -\frac{\ii}{2}\sum_{\alpha}\Bigg[
\left(\frac{\partial f}{\partial q_\alpha}\frac{\partial g}{\partial q_\alpha}
+\ii\frac{\partial f}{\partial q_\alpha}\frac{\partial g}{\partial p_\alpha}
-\ii\frac{\partial f}{\partial p_\alpha}\frac{\partial g}{\partial q_\alpha}
...
\textbf{利用} \(\boldsymbol A = \boldsymbol p \times \boldsymbol J - \alpha m\,\hat{\boldsymbol r}\) 的矢量形式，已知 \(\boldsymbol J\) 是守恒量，且计算
\[
...
计算算符作用。由定义 \(\widehat F f \equiv [f,F]\)，
\[
...
形式解为
\[
f(t) = \ee^{t\hat H} f(0) \equiv \sum_{n=0}^\infty \frac{t^n}{n!}\hat H^{\,n} f(0).
\]
...
\[
\begin{aligned}
q(t) &= \ee^{t\hat H} q_0 = \sum_{n=0}^\infty \frac{t^{2n}}{(2n)!}\hat H^{2n} q_0
...
\[
\begin{aligned}
p(t) &= \ee^{t\hat H} p_0 = \sum_{n=0}^\infty \frac{t^{2n}}{(2n)!}\hat H^{2n} p_0
