...
\hat y\cdot\boldsymbol\sigma = \sigma_y = \begin{pmatrix}0&-\ii\\\ii&0\end{pmatrix}.
\]
解本征方程:
\[
\begin{pmatrix}0&-\ii\\\ii&0\end{pmatrix}\begin{pmatrix}a\\b\end{pmatrix} = -\begin{pmatrix}a\\b\end{pmatrix}
\;\Longrightarrow\;
\begin{cases}
-\ii b = -a,\\
\ii a = -b,
...
对于 $S_y$:
\[
\rho\sigma_y = \frac{1}{2}\begin{pmatrix}1&\ii\\-\ii&1\end{pmatrix}\begin{pmatrix}0&-\ii\\\ii&0\end{pmatrix}
= \frac{1}{2}\begin{pmatrix}-1&-\ii\\\ii&-1\end{pmatrix},
\]
\[
...
\[
\rho P_{+\hat n} = \frac{1}{4}\bigl(I-\sigma_y\bigr)\bigl(I+\hat n\cdot\boldsymbol\sigma\bigr),
\]
其中利用了 $\rho = \frac{1}{2}(I-\sigma_y)$(因 $\chi_{-y}$ 对应的 Bloch 矢量为 $-\hat y$)。展开并取迹,利用 $\operatorname{Tr}\sigma_i=0$,$\operatorname{Tr}(\sigma_i\sigma_j)=2\delta_{\ii j}$:
\[
\begin{aligned}
\operatorname{Tr}(\rho P_{+\hat n})
&= \frac{1}{4}\operatorname{Tr}\bigl[I - \sigma_y + \hat n\cdot\boldsymbol\sigma - (\hat n\cdot\boldsymbol\sigma)\sigma_y\bigr]\\[2mm]
&= \frac{1}{4}\bigl(2 + 0 + 0 - 2 n_y\bigr)
= \frac{1}{2}(1 - n_y).
\end{aligned}
\]
...
- \frac{2}{3}\begin{pmatrix}0&-\ii\\\ii&0\end{pmatrix}
\right].
\]
计算各矩阵元:
\begin{itemize}
\item $\rho_{11} = \frac{1}{2}(1 + 0 + 0) = \frac{1}{2}$
\item $\rho_{12} = \frac{1}{2}\left(0 + \frac{1}{3}\cdot 1 - \frac{2}{3}\cdot(-\ii)\right) = \frac{1}{2}\left(\frac{1}{3} + \frac{2\ii}{3}\right) = \frac{1}{6} + \frac{\ii}{3}$
\item $\rho_{21} = \frac{1}{2}\left(0 + \frac{1}{3}\cdot 1 - \frac{2}{3}\cdot \ii\right) = \frac{1}{2}\left(\frac{1}{3} - \frac{2\ii}{3}\right) = \frac{1}{6} - \frac{\ii}{3}$
\item $\rho_{22} = \frac{1}{2}(1 + 0 + 0) = \frac{1}{2}$
\end{itemize}
因此
\[
\boxed{\rho = \frac{1}{2}\begin{pmatrix}
1 & \dfrac{1}{3} + \dfrac{2\ii}{3}\\[6pt]
\dfrac{1}{3} - \dfrac{2\ii}{3} & 1
\end{pmatrix}.}
\]
...
\frac{\ii(1+2\ii)}{3} & -\ii \\[4pt]
\ii & -\frac{\ii(1-2\ii)}{3}
\end{pmatrix},
\]
取迹:
\[
\operatorname{Tr}(\rho\sigma_y) = \frac{1}{2}\left(\frac{\ii(1+2\ii)}{3} - \frac{\ii(1-2\ii)}{3}\right)
= \frac{1}{2}\cdot\frac{\ii(1+2\ii-1+2\ii)}{3}
= \frac{1}{2}\cdot\frac{4\ii^2}{3} = -\frac{2}{3},
\]
与上述结果一致。
\end{solution}
...
+ a_2\begin{pmatrix}0&-\ii\\\ii&0\end{pmatrix}
