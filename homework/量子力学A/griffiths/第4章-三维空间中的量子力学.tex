...
\[
[x_i,x_j]=0,\qquad [p_i,p_j]=0,\qquad [x_i,p_j]=\ii\hbar\delta_{\ii j}.
\]
...
\]
取 $Q=x_i$ 得 $[p_j^2,x_i]=-2\ii\hbar\delta_{\ii j}p_j$,故
\[
...
(3) 每一对共轭分量满足
\[
\sigma_{x_i}\sigma_{p_j}\ge \frac{\hbar}{2}\delta_{\ii j}.
\]
